...
export async function stoch(
  ...
  return {
    stoch: replaceEmptyItemWithNaN(stoch),
    stochMa: replaceEmptyItemWithNaN(stochMa),
  };
}
...
function getPrevItem<T>(list: T[] | readonly T[], currentIndex: number, length = 1): T | undefined {
