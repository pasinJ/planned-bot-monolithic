...
import { existSymbolModelByNameAndExchange } from '#features/symbols/DAOs/symbol.feature.js';
...
export function addBtStrategyRouteOptions(deps: AppDeps): RouteOptions {
  ...
  return {
    ...
    handler: buildAddBtStrategyController({
      dateService,
      symbolDao: { existByNameAndExchange: symbolDao.composeWith(existSymbolModelByNameAndExchange) },
      btStrategyDao: {
