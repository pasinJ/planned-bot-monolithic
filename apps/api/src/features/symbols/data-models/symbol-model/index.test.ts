...
import { createSymbolModel } from './index.js';

function mockValidData() {
  return { ...omit(['version', 'createdAt', 'updatedAt'], mockSymbol()), id: randomString() };
}
...
describe('Create symbol model', () => {
  describe('id property', () => {
    ...
    it.each([
      ...
      const result = createSymbolModel(data, currentDate);
  ...
  describe('filters property', () => {
    ...
    it('WHEN the property includes duplicated filter type THEN it should return Left of error', () => {
    ...
    it('WHEN the property is an empty array THEN it should return Right', () => {
    ...
    describe('lot size filter type', () => {
      ...
      describe('min quantity property', () => {
        ...
        it('WHEN the property has more than 8 digits THEN it should be rounded up to the closest number with 8 digits', () => {
          const { float9Digits, float8Digits } = random9DigitsPositiveFloatWithRoundUp(minRange);
      ...
      describe('max quantity property', () => {
        ...
        it('WHEN maxQty property is less than minQty property THEN it should return Left of error', () => {
        ...
        it('WHEN the property has more than 8 digits THEN it should be rounded up to the closest number with 8 digits', () => {
          const { float9Digits, float8Digits } = random9DigitsPositiveFloatWithRoundUp(maxRange);
          const filter = assoc(subPropertyName, float9Digits, mockFilter());
          const data = assoc(propertyName, [filter], mockValidData());
          const result = createSymbolModel(data, currentDate);
          expect(result).toHaveProperty(`right.filters[0].${subPropertyName}`, float8Digits);
    ...
    describe('min notional filter type', () => {
      ...
      describe('apply to market property', () => {
        ...
        it('WHEN applyToMarket property is not a boolean THEN it should return Left of error', () => {
    ...
    describe('price filter type', () => {
      ...
      describe('max price property', () => {
        ...
        it('WHEN maxPrice property is less than minPrice property THEN it should return Left of error', () => {
          const validFilter = mockFilter();
  ...
  describe('WHEN every perperty is valid', () => {
    it('THEN it should return Right of symbol model', () => {
      const validData = mockValidData();
      expect(createSymbolModel(validData, currentDate)).toEqualRight({
        ...validData,
        version: 0,
